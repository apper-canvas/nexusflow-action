...
import ContactsFeature from '../components/contacts/ContactsFeature';
      ...
      <aside className="hidden md:flex flex-col w-64 bg-white dark:bg-surface-800 shadow-card">
        ...
        <nav className="flex-1 overflow-y-auto py-4 px-3">
          <ul className="space-y-2">
            ...
            <li>
              <Link to="/contacts" className="flex items-center w-full p-3 rounded-lg transition-all bg-primary bg-opacity-10 text-primary dark:bg-opacity-20">
